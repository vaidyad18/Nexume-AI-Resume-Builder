...
const ExperienceForm = () => {
  ...
  return (
    ...
    >
      <p className="font-bold text-xl sm:text-2xl">Work Experience</p>
          ...
          <div key={i} className="">
            <div className="grid outline-1 rounded-xl p-3 sm:p-5 grid-cols-2 gap-x-10 gap-y-4 mt-5 mb-3">
              <div className="flex-col col-span-2">
                <label className="font-semibold capitalize text-xs sm:text-sm">Position Title</label>
                <input
                  required
              ...
              <div className="flex-col">
                <label className="font-semibold capitalize text-xs sm:text-sm">Company Name</label>
                <input
                  required
                  onChange={(event) => handleChange(i, event)}
                  name="company"
              ...
              <div className="flex-col">
                <label className="font-semibold capitalize text-xs sm:text-sm">City</label>
                <input
                  required
                  onChange={(event) => handleChange(i, event)}
                  name="city"
      ...
      <div className="flex items-center mt-4 justify-between">
        ...
        <button
          ...
          disabled={loading}
          type="submit"
          className=" bg-blue-500 text-white font-semibold hover:bg-blue-600 text-sm sm:text-[16px] cursor-pointer duration-150 py-[6px] px-8 rounded-sm"
        >
