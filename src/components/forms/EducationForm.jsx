    ...
    >
      ...
      {educationList.map((item, i) => (
        <div key={i} className="">
          <div className="grid outline-1 rounded-xl p-5 grid-cols-2 gap-x-10 gap-y-4 mt-5 mb-3">
            ...
            <div className="flex-col">
              <label className="font-semibold capitalize text-sm">State</label>
              <input
                required
                onChange={(event) => handleChange(i, event)}
                name="state"
      ...
      <div className="flex items-center mt-4 justify-between">
        ...
        <button
          ...
          disabled={loading}
          type="submit"
          className=" bg-blue-500 hover:bg-blue-600 cursor-pointer duration-150 text-white font-semibold py-[6px] px-8 rounded-sm"
        >
